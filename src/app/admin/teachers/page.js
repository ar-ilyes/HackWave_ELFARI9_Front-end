    ...
    <svg className='m-auto mt-3' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path fill="white" d="M4 8a6 6 0 0 1 4.03-5.67a2 2 0 1 1 3.95 0A6 6 0 0 1 16 8v6l3 2v1H1v-1l3-2V8zm8 10a2 2 0 1 1-4 0h4z"/></svg>
        ...
        <div className=" flex flex-row h-screen w-screen">
            ...
            <div className='basis-4/5 flex flex-col justify-center items-center space-y-6'>
                <h1 className=" underline text-3xl font-bold">Teachers</h1>
                <Popover>
                    <PopoverTrigger asChild>
                    <Button variant="outline" className=" relative left-1/3 text-white font-semibold bg-green-500 hover:text-green-500 hover:border-2 hover:border-solid hover:border-green-500">Add a new teacher</Button>
                    </PopoverTrigger>
                    <PopoverContent className="w-80">
                    <div className="grid gap-4">
                        <div className="space-y-2">
                        <h4 className="font-medium leading-none">Teacher</h4>
                        <p className="text-sm text-muted-foreground">
                            you can add a new teachers informations here
                        </p>
                        </div>
                        ...
                        <div className="grid grid-cols-3 items-center gap-4">
                            <Label htmlFor="password">groups</Label>
                            <Input
                            id="password"
                            defaultValue=""
                            className="col-span-2 h-8"
            ...
            <Table>
                    ...
                    <TableRow className="bg-slate-600 text-lg ">
                        ...
                        <TableHead className="font-bold text-white" >Subject</TableHead>
                                    ...
                                    <TableCell>
                                            <Popover>
                                                ...
                                                <div className="grid gap-4">
                                                    ...
                                                    <h4 className="font-medium leading-none">Teacher</h4>
                                                    <p className="text-sm text-muted-foreground">
                                                        you can edit teachers informations here
                                                    </p>
                                                    </div>
                                                    <div className="grid gap-2">
                                                    <div className="grid grid-cols-3 items-center gap-4">
