        ...
        <div className=" flex flex-row h-screen w-screen">
            <div className=' basis-1/5 blueColor flex flex-col justify-center items-center space-y-10 '>
                ...
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <Link href="/admin/teachers" className=' rounded-lg text-white hover:bg-white hover:text-blue-900 w-full h-10 flex flex-row pl-14 space-x-3 items-center'>
                    ...
                    <Link href="/admin/students" className=' rounded-lg text-white hover:bg-white hover:text-blue-900 w-full h-10 flex flex-row pl-14 space-x-3 items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 10a4 4 0 1 0 0-8a4 4 0 0 0 0 8Zm-6.5 3a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 5ZM21 10.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0Zm-9 .5a5 5 0 0 1 5 5v6H7v-6a5 5 0 0 1 5-5Zm-7 5c0-.693.1-1.362.288-1.994l-.17.014A3.5 3.5 0 0 0 2 17.5V22h3v-6Zm17 6v-4.5a3.5 3.5 0 0 0-3.288-3.494c.187.632.288 1.301.288 1.994v6h3Z"/></svg>
                        <p>Students</p>
                    </Link>

                    <Link href="/admin/parents" className=' rounded-lg text-white hover:bg-white hover:text-blue-900 w-full h-10 flex flex-row pl-14 space-x-3 items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 10a4 4 0 1 0 0-8a4 4 0 0 0 0 8Zm-6.5 3a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 5ZM21 10.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0Zm-9 .5a5 5 0 0 1 5 5v6H7v-6a5 5 0 0 1 5-5Zm-7 5c0-.693.1-1.362.288-1.994l-.17.014A3.5 3.5 0 0 0 2 17.5V22h3v-6Zm17 6v-4.5a3.5 3.5 0 0 0-3.288-3.494c.187.632.288 1.301.288 1.994v6h3Z"/></svg>
                        <p>Parents</p>
                    </Link>
                    ...
                    <Link href="/admin/schedule" className=' rounded-lg text-white hover:bg-white hover:text-blue-900 w-full h-10 flex flex-row pl-14 space-x-3 items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 10a4 4 0 1 0 0-8a4 4 0 0 0 0 8Zm-6.5 3a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 5ZM21 10.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0Zm-9 .5a5 5 0 0 1 5 5v6H7v-6a5 5 0 0 1 5-5Zm-7 5c0-.693.1-1.362.288-1.994l-.17.014A3.5 3.5 0 0 0 2 17.5V22h3v-6Zm17 6v-4.5a3.5 3.5 0 0 0-3.288-3.494c.187.632.288 1.301.288 1.994v6h3Z"/></svg>
                        <p>Sessions</p>
                    </Link>
            ...
            <div className='basis-4/5 flex flex-col justify-center items-center space-y-6'>
                <h1 className=" underline text-3xl font-bold">Parents</h1>
                <Popover>
                    <PopoverTrigger asChild>
                    <Button variant="outline" className=" relative left-1/3 text-white font-semibold bg-green-500 hover:text-green-500 hover:border-2 hover:border-solid hover:border-green-500">Add a new Parent</Button>
                    </PopoverTrigger>
                    <PopoverContent className="w-80">
                    <div className="grid gap-4">
                        <div className="space-y-2">
                        <h4 className="font-medium leading-none">Parent</h4>
                        <p className="text-sm text-muted-foreground">
                            you can add a new Parent from here
                        </p>
                        </div>
                        ...
                        <div className="grid grid-cols-3 items-center gap-4">
                            <Label htmlFor="children">children emails</Label>
                            <Input
                            id="children"
                            defaultValue=""
                            className="col-span-2 h-8"
            ...
            <Table>
                    ...
                    <TableRow className="bg-slate-600 text-lg ">
                        ...
                        <TableHead className="font-bold text-white" >Number of children</TableHead>
                        <TableHead className="font-bold text-white" >children</TableHead>
                        ...
                        {teachers.map((item)=>{
                            return(
                                <TableRow>
                                    ...
                                    <TableCell>{item.numberOfChildren}</TableCell>
                                    ...
                                    <TableCell>
                                            <Popover>
                                                ...
                                                <div className="grid gap-4">
                                                    ...
                                                    <h4 className="font-medium leading-none">Parent</h4>
                                                    <p className="text-sm text-muted-foreground">
                                                        you can edit the parents informations here
                                                    </p>
                                                    </div>
                                                    <div className="grid gap-2">
                                                    <div className="grid grid-cols-3 items-center gap-4">
