        ...
        <div className=" flex flex-row h-screen w-screen">
            <div className=' basis-1/5 blueColor flex flex-col justify-center items-center space-y-10 '>
                ...
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <Link href={`/students/${params.fullname}`} className=' rounded-lg text-white hover:bg-white hover:text-blue-900 w-full h-10 flex flex-row pl-14 space-x-3 items-center'>
                    ...
                    <Link href={`/students/${params.fullname}/subjects`} className=' rounded-lg text-white hover:bg-white hover:text-blue-900 w-full h-10 flex flex-row pl-14 space-x-3 items-center'>
                    ...
                    <Link href={`/students/${params.fullname}/documents`} className=' rounded-lg text-white hover:bg-white hover:text-blue-900 w-full h-10 flex flex-row pl-14 space-x-3 items-center'>
            ...
            <div className='basis-4/5 flex flex-col justify-center items-center space-y-6'>
                <div className=' grid grid-cols-2 gap-4 items-center'>
                    ...
                    <div className='  rounded-md items-center justify-center px-14 py-5 shadow-lg bg-white space-y-6 '>
                        ...
                        <button className=' px-5 py-2 bg-black shadow-md text-white font-semibold rounded-md '> <Link href={`/students/${params.fullname}/timetable`}> Details </Link></button>
                    </div>

                    {/* ///////////////////////////////////////////////////////// */}
                    <div className='  rounded-md  py-1 shadow-lg bg-white justify-around flex flex-col items-center px-1 space-y-4 pb-5 col-span-full'>
