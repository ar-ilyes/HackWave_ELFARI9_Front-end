    ...
    <main className="w-full h-full backgroundColor">
        ...
        <div className=' basis-1/5 blueColor flex flex-col justify-center items-center space-y-10 '>
                ...
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <Link href="/parent/said/children" className=' rounded-lg text-white hover:bg-white hover:text-blue-900 w-full h-10 flex flex-row pl-14 space-x-3 items-center'>
