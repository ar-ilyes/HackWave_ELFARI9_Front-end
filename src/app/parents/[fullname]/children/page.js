                ...
                <div className="  flex-col justify-center items-center space-y-2 overflow-y-scroll h-3/4 px-4">
                    <div className="rounded-lg bg-white flex flex-row justify-between items-center space-x-36 px-8 py-1">
                        <div className="flex flex-row space-x-5 items-center">
                            <Image src={avatar} className="w-1/2 h-1/2"></Image>
                            <a href="/parents/said/children/1"><h1 className="  font-bold text-lg w-20 blueTextColor">child-1</h1></a>
                        </div>
                        <h1 className=" font-bold text-lg blueTextColor">L2</h1>
                    </div>
